    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const workshopData = {
                ...
                formFields: workshop?.formFields || null,
                isArchived: workshop?.isArchived || false
            };
            
            const updatedWorkshop = await workshopService.updateWorkshop(workshop.id, workshopData);
